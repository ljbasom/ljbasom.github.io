...
**Lines 67-69, 104-106, and 116-118**

(B) .Rmd Line numbers for inspecting data intake:  

**Lines 71, 108, and 120**
...
**Lines 89, 91, 133, 134, 149, 159, 169, 199, and 284**
...
**Lines 91, 134, and 83-84**

(F) .Rmd Line number(s) for use of user-defined functions: 

**Lines 187-196, 200, 304-306, and 310 (labeller functions)**
...
**Lines 150, 160, 170, 208, 230, 238, 248, 254, 272, and 328**

(B) .Rmd Line number(s) for use of multiple aesthetics:  

**Lines 200, 230, 238, 262, and 310**

(C) .Rmd Line number(s) for use of layered graphics:  

**Lines 160, 170, 208, 230, 238, 248, 254, 272, and 328**
